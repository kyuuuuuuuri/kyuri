...
public class MurmurNames {
    ...
    /**
     * retweetuserのプロパティ名を返します。
     * 
     * @return retweetuserのプロパティ名
     */
    public static PropertyName<Integer> retweetuser() {
        return new PropertyName<Integer>("retweetuser");
    }
     ...
     * retuserのプロパティ名を返します。
     * 
     * @return retuserのプロパティ名
     */
    public static _TuserNames retuser() {
        return new _TuserNames("retuser");
    }
    ...
    /**
     * favoliteReVarのプロパティ名を返します。
     * 
     * @return favoliteReVarのプロパティ名
     */
    public static _FavoliteNames favoliteReVar() {
        return new _FavoliteNames("favoliteReVar");
    }

    /**
     * retweetsのプロパティ名を返します。
     * 
     * @return retweetsのプロパティ名
     */
    public static _RetweetsNames retweets() {
        return new _RetweetsNames("retweets");
    }
    ...
    public static class _MurmurNames extends PropertyName<Murmur> {
         ...
         * @return retweetuserのプロパティ名
         */
        public PropertyName<Integer> retweetuser() {
            return new PropertyName<Integer>(this, "retweetuser");
        }
         ...
         * @return retuserのプロパティ名
         */
        public _TuserNames retuser() {
            return new _TuserNames(this, "retuser");
        }
         ...
         * @return favoliteReVarのプロパティ名
         */
        public _FavoliteNames favoliteReVar() {
            return new _FavoliteNames(this, "favoliteReVar");
        }
         ...
         * @return retweetsのプロパティ名
         */
        public _RetweetsNames retweets() {
            return new _RetweetsNames(this, "retweets");
        }
