				...
				<div class="span4">
					<div class="setspanMenu">
						<ul class="nav nav-list">
							...
							<a href="#" onclick="$('#settingMain').load('${f:url('changeUsername')}');">プロフィールを変える</a></li>
							<li id="change2" class="">
							<a href="#" onclick="$('#settingMain').load('${f:url('changeUserImg')}');">画像を変える</a></li>
							<li id="change3" class="">
							<a href="#" onclick="$('#settingMain').load('${f:url('changePassword')}');">パスワードを変える</a></li>
						</ul>
					</div>
				</div>
