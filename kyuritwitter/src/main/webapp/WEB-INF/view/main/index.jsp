		...
		<div class="container">
			<div class="row">
				<div class="span4">
					...
					${mydata.newMur}　${mydata.newMurD}</font>
					</c:if>
				...
				<table class="table table-bordered">
					<thead>
						<tr><th>${mydata.usernick }</th></tr>
					</thead>
					<tr><td>${mydata.follow }<br><s:link href="/followlist/followpage/${mydata.userid}" style="text-decoration: none">フォロー<br>している</s:link></td>
					<td>${mydata.followed }<br><s:link href="/followlist/followedlist/${mydata.userid}" style="text-decoration: none">フォロー<br>されている</s:link></td></tr>
					<tr><td>${mydata.postNum }<br><s:link href="showdata/${mydata.userid}" style="text-decoration: none">投稿数</s:link></td></tr>

					<s:form>
						<input type="text" name="tubuyaki"  class="style"  value="" />
						<input type="submit" name = "ins_tubuyaki" value="投稿" class="input_button" />
					</s:form>
				</table>
